...
export default function BeachPartyEnvironment({ palette = 2, isRecording = false, isLoading = false }) {
  const isP1 = palette === 1;
  ...
  return (
    <div className={`beach-env-root ${isP1 ? 'env-palette-1' : 'env-palette-2'}`} aria-hidden="true">
      {/* ── 1. Sky & Glowing Sun with Drifting Clouds ── */}
      ...
      >
        <svg className="env-palm-svg" viewBox="-30 -80 300 520" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M70 440 C85 270 110 160 155 45 C145 45 122 160 92 440 Z" fill={isP1 ? '#5c3317' : '#3d2612'} stroke="#000" strokeWidth="3.5" />
          <path d="M78 380 L106 368 M86 310 L118 298 M96 230 L130 218 M112 150 L142 138 M130 90 L152 82" stroke={isP1 ? '#854d0e' : '#713f12'} strokeWidth="3.5" strokeLinecap="round" />
          
          {/* Wrapped Festival Neon Fairy Lights */}
          <path d="M75 410 Q100 395 102 380 Q105 350 88 335 Q115 315 116 295 Q125 250 102 235 Q130 210 134 185 Q145 140 120 125 Q145 105 148 85" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5" strokeDasharray="3 5" fill="none" />
          <circle cx="85" cy="400" r="3.5" fill="#ffe000" className="fairy-glow" />
          <circle cx="98" cy="340" r="3.5" fill="#ff087f" className="fairy-glow" />
          <circle cx="112" cy="270" r="3.5" fill="#00f0ff" className="fairy-glow" />
          <circle cx="126" cy="190" r="3.5" fill="#ffe000" className="fairy-glow" />
          <circle cx="138" cy="115" r="3.5" fill="#ff087f" className="fairy-glow" />
          ...
          <g className="env-palm-fronds">
            ...
            <path d="M155 45 Q150 -75 110 -65 Q135 -30 155 45" fill={isP1 ? '#15803d' : '#0d5338'} stroke="#000" strokeWidth="3.5" />
            <path d="M155 45 Q195 -65 235 -20 Q185 15 155 45" fill={isP1 ? '#15803d' : '#0d5338'} stroke="#000" strokeWidth="3.5" />
            
            {/* Upper Flaring Fronds */}
            <path d="M155 45 Q30 -45 -20 -10 Q40 20 155 45" fill={isP1 ? '#16a34a' : '#106b47'} stroke="#000" strokeWidth="3.5" />
            <path d="M155 45 Q70 -20 0 25 Q60 55 155 45" fill={isP1 ? '#22c55e' : '#16a34a'} stroke="#000" strokeWidth="3.5" />
            <path d="M155 45 Q125 -50 45 -25 Q95 15 155 45" fill={isP1 ? '#4ade80' : '#22c55e'} stroke="#000" strokeWidth="3.5" />
            
            {/* Right Outer & Broad Canopy Fronds */}
            <path d="M155 45 Q225 -10 255 55 Q195 50 155 45" fill={isP1 ? '#4ade80' : '#22c55e'} stroke="#000" strokeWidth="3.5" />
            <path d="M155 45 Q245 25 270 95 Q205 75 155 45" fill={isP1 ? '#16a34a' : '#15803d'} stroke="#000" strokeWidth="3.5" />
            <path d="M155 45 Q190 75 220 125 Q175 85 155 45" fill={isP1 ? '#15803d' : '#14532d'} stroke="#000" strokeWidth="3.5" />
            
            {/* Lower Drooping Frond */}
            <path d="M155 45 Q115 85 65 130 Q120 75 155 45" fill={isP1 ? '#22c55e' : '#16a34a'} stroke="#000" strokeWidth="3.5" />

            {/* Front Highlight Sunlit Frond */}
            <path d="M155 45 Q90 5 25 40 Q85 60 155 45" fill={isP1 ? '#86efac' : '#86efac'} stroke="#000" strokeWidth="2.5" />
          </g>
        </svg>
      ...
      {/* ── 5. Interactive Right Coconut Tree with Fairy Lights & Coconuts ── */}
      <div
      ...
      <div className="env-side-dancers-left">
        ...
        >
          <svg viewBox="0 0 110 170" width="130" height="205">
            ...
            <path d="M35 55 L75 55 L70 95 L40 95 Z" fill={isP1 ? '#ff0055' : '#0d5338'} stroke="#000" strokeWidth="3" />
            <rect x="36" y="86" width="38" height="18" rx="4" fill={isP1 ? '#38bdf8' : '#ffe000'} stroke="#000" strokeWidth="2.5" />
        ...
        >
          <svg viewBox="0 0 110 170" width="138" height="215">
            ...
            {/* Boardshorts */}
            <path d="M34 82 L76 82 L72 112 L56 112 L54 94 L52 112 L36 112 Z" fill={isP1 ? '#3b82f6' : '#ffe000'} stroke="#000" strokeWidth="3" />
            {/* Tropical Printed Shirt */}
            <path d="M34 50 Q55 56 76 50 L76 86 Q55 90 34 86 Z" fill={isP1 ? '#fbbf24' : '#ff087f'} stroke="#000" strokeWidth="3" />
      ...
      <div className="env-side-dancers-right">
        ...
        >
          <svg viewBox="0 0 110 170" width="130" height="205">
            ...
            {/* Flowing Beach Dress */}
            <path d="M36 52 L74 52 L78 100 L32 100 Z" fill={isP1 ? '#ec4899' : '#ff087f'} stroke="#000" strokeWidth="3" />
            <path d="M32 100 Q55 110 78 100 L82 118 Q55 125 28 118 Z" fill={isP1 ? '#ffe000' : '#106b47'} stroke="#000" strokeWidth="2.5" />
            {/* Left Arm Flowing */}
        ...
        >
          <svg viewBox="0 0 110 170" width="138" height="215">
            ...
            {/* Boardshorts */}
            <path d="M34 82 L76 82 L72 114 L56 114 L54 94 L52 114 L36 114 Z" fill={isP1 ? '#10b981' : '#0d5338'} stroke="#000" strokeWidth="3" />
            {/* Muscle Beach Tank */}
